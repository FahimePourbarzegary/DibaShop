...
import { autoLogin, RegisterUser } from "../services/features/userSlice";
...
function RegisterPage() {
  ...
  const onSubmit = async (values: initialValuesType) => {
    const { name, lastname, username, email, password, address } = values;
    ...
    if (!loggedIn) setErrorUser("نام کاربری یا ایمیل از قبل وجود دارد");
  };
  //*******************/
        ...
        <div className="grid  grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div className="flex flex-col">
            ...
            <input
              ...
              id="password"
              className="mt-3 p-3 rounded-xl bg-slate-800 password-slate-400 text-slate-400  focus:outline-none focus:ring focus:ring-primary-200"
              placeholder="رمز"
            />
          </div>
          <div className="flex flex-col">
